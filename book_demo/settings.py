...
SECRET_KEY = 'django-insecure--ah1&0m858@9te(1c*h24m5f(tphh$(x1w*)t4%if$t6vb_h*x'
...
DATABASE_ROUTERS = ['routers.db_routers.ItemsRouter', 'routers.db_routers.PersonsRouter', 'routers.db_routers.OrdersRouter']
